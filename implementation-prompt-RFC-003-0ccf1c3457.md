# Implementation Prompt for RFC-003: 角色设计&角色资产库系统
...
## Context
This implementation covers RFC-003, which focuses on 角色设计&角色资产库系统。Please refer to the following documents:
